...
Start-BitsTransfer -Source "https://github.com/simonmeggle/send_gearman_powershell/raw/master/send_gearman.windows.amd64.exe" -Destination "$send_gearmanpath\send_gearman.windows.amd64.exe"
